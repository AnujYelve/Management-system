...
import { BookOpen, Mail, User, Lock, Loader2, ArrowLeft } from 'lucide-react';
        ...
        <div className="relative z-10 flex items-center justify-center px-4 py-20">
          ...
          >
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-slate-200/50 p-8 md:p-10">
              {/* Header - Left aligned for natural feel */}
              <div className="mb-8">
                ...
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mt-1">Sign in to continue reading</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-200">
                <p className="text-sm text-slate-600 text-center">
                  ...
                  <a href="/user/register" className="text-indigo-600 hover:text-indigo-700 font-medium">
                    Create one here
                  </a>
                </p>
              </div>
