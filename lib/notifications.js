...
export async function createNotification(userId, storeId, message, type) {
  ...
  // ── 2 & 3. Socket.io temporarily disabled (Vercel serverless incompatible) ─
  // DB notification is already persisted above. Realtime push will be
  // re-enabled when deployed to a persistent Node.js host.
